...
void reader_meun()
{
	printf(" ----------------------------------------------------------------------\n");
	printf("                                      选择操作                \n");
	printf("    [1].查询图书	[2].借书	[3].还书		[0].退出系统    \n");
	printf("    [4].借书系统	[5].还书系统	[6].修改密码       \n");
	printf(" ----------------------------------------------------------------------\n");
}
...
void admin_op(MYSQL *sock, char *admin_id)
{
	while (1)
	{
		...
		else if (a_op == 1)
		{
			...
			//填充结果集 
			cout << "书本编号	书本名称	书本类型	书本价格	书本出版社	书本作者	书本状态\n";
